...
public class GreenRoomQuestionQueryRepository {
    ...
    /**
     * 그린룸 검색어 조회 시 그린룸질문 목록 조회에 사용 (B3, B3-1 화면)
     *
    ...
    private BooleanExpression questionContains(String searchWord) {
        if (StringUtils.isBlank(searchWord)) {
            return null;
        }

        return greenRoomQuestion.question.contains(searchWord);
    }
}
