...
public class PrivateQuestionApiController {
     ...
     */
    @PostMapping
    public CreateResponse createQuestion(@AuthenticationPrincipal JwtAuthentication authentication,
     ...
     */
    @PostMapping("/answer")
    public CreateResponse createQuestionAnswer(@AuthenticationPrincipal JwtAuthentication authentication,
     ...
     */
    @GetMapping
    public List<GetResponse> getQuestions(@AuthenticationPrincipal JwtAuthentication authentication, Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public GetDetailResponse getQuestion(@PathVariable("id") Long id,
    ...
    public void updateQuestionAnswer(@PathVariable("id") Long id,
                                     @AuthenticationPrincipal JwtAuthentication authentication,
