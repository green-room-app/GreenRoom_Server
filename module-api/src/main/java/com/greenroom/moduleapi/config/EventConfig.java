...
public class EventConfig {
    ...
    public SearchEventListener eventListener(EventBus eventBus, GreenRoomQuestionSearchService greenRoomQuestionSearchService) {
        return new SearchEventListener(eventBus, greenRoomQuestionSearchService);
    }
}
